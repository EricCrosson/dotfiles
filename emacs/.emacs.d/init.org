...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  ;; install quelpa if it doesn't exist yet
  (unless (require 'quelpa)
    (with-temp-buffer
...
*** Hidden mode line
    #+BEGIN_SRC emacs-lisp :tangle yes
      (quelpa '(hidden-mode-line :repo "EricCrosson/hidden-mode-line" :fetcher github))
    #+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (quelpa '(file-operations :repo "EricCrosson/file-operations" :fetcher github))
  (use-package file-operations)
#+END_SRC
*** Toggle quotes conf
#+BEGIN_SRC emacs-lisp :tangle yes
  (quelpa 'toggle-quotes)
  (use-package toggle-quotes
      (bind-key "M-'" 'toggle-quotes esc-mode-map))
#+END_SRC
