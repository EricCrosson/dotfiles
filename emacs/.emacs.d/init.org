...
#+BEGIN_SRC emacs-lisp :tangle yes
  (require-package '(emacs+ compilation+ buffer+ boilerplate org+ os-interaction programming+ dired-config))
#+END_SRC
...
#+END_SRC
*** Find-file hook
TODO: this could be idle-loaded, as it will load all of mojo.el
#+BEGIN_SRC emacs-lisp :tangle yes
...
#+BEGIN_SRC emacs-lisp :tangle site-lisp/esc-lisp/esc-mode.el
  ...
  (esc-key "C-c <f8>" 'hsplit-last-buffer-follow-mode)
