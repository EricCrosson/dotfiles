...
#+BEGIN_SRC emacs-lisp :tangle site-lisp/esc-lisp/esc-mode.el
  ;; todo: pull buffer management into anothe rhydra
...
#+BEGIN_SRC emacs-lisp :tangle site-lisp/esc-lisp/esc-mode.el
  ...
  (defhydra hydra-scroll-buffer (esc-mode-map "C-,")
    "esc/scroll-buffer"
    ("j" esc/scroll-up-slight "up")
    ("k" esc/scroll-down-slight "down"))

  (defhydra hydra-window-adjustment (esc-mode-map "C-c w")
    "window adjustment"
    ...
    ;; TODO; include the amaranth hydras
