-- d4c85d6bb91e15633af554ad69f51eee
...
dispatcher = M.fromList $
  ...
  ] ++ [("Matrix.identity",transform(Matrix.identity)),("Matrix.isIdentity",transform(Matrix.isIdentity)),("Matrix.dyadic",transform(\ (x1,x2) -> Matrix.dyadic x1 x2)),("Matrix.transpose",transform(Matrix.transpose))]
...
arityList :: [(Text,Int)]
arityList = [("Matrix.identity",arity Matrix.identity),("Matrix.isIdentity",arity Matrix.isIdentity),("Matrix.dyadic",arity Matrix.dyadic),("Matrix.transpose",arity Matrix.transpose)]
