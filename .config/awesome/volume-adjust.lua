...
local offsety = dpi(280)
local screen = awful.screen.focused()
local icon_dir = gears.filesystem.get_configuration_dir() .. "/icons/volume/pastel/"
...
-- create a timer to hide the volume adjust component
...
awesome.connect_signal("volume_change", function()
    ...
    awful.spawn.easy_async_with_shell("pamixer --get-volume-human | tr -d %", function(stdout)
